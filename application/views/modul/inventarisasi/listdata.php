...
?>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Data Inventarisasi</h3>
            </div>
            <!-- /.box-header -->
 ...
 <a href="<?php echo base_url(); ?>index.php/inventarisasi/tambah" class="btn btn-default"><i class="glyphicon glyphicon-plus"></i> Tambah</a>			 
              <p>
