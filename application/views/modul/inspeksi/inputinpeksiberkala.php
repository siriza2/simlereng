             ...
             <div class="col-md-12">
              ...
              <div class="form-horizontal">
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input class="form-control" id="inputEmail3" placeholder="" type="text" disabled="" VALUE="<?php echo $nmpropinsi; ?>">
                  </div>
                </div>
                <div class="form-group">
                  <label   class="col-sm-2 control-label">Ruas Jalan</label>
                  <div class="col-sm-9">
						<input class="form-control" id="inputPassword3" placeholder="" type="text" disabled="" VALUE="<?php echo $nmruas; ?>">
                  </div>
                </div>
				 <div class="form-group">
                  <label   class="col-sm-2 control-label">Arah Jalan</label>
                  <div class="col-sm-9">
                    <input class="form-control" id="inputPassword3" placeholder="" type="text" disabled="" VALUE="<?php echo $arahjalan1; ?> <?php echo $arahjalan2; ?> " >
                  </div>
                </div>
				 <div class="form-group">
				 ...
				 <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input class="form-control" id="inputPassword3" placeholder="" type="text" disabled="" VALUE="<?php echo $km1; ?> <?php echo $km2; ?> ">
                  </div>
                </div>
				 <div class="form-group">
                  <label   class="col-sm-2 control-label">Bagian Lereng</label>
                  <div class="col-sm-9">
                    <input class="form-control" id="inputPassword3" placeholder="" type="text" disabled="" VALUE="<?php echo $bagian_lereng; ?>">
                  </div>
                </div>
				<div class="form-group">
                  <label   class="col-sm-2 control-label">Status Jalan</label>
                  <div class="col-sm-9">
                    <input class="form-control" id="inputPassword3" placeholder="" type="text" disabled="" VALUE="<?php echo $status_jalan; ?>">
                  </div>
                </div>
				<div class="form-group">
            ...
            <div class="col-xs-12">
			  ...
			  <div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
				  ...
				  <li><a href="#lereng" data-toggle="tab">Badan Jalan</a></li>
				  <li><a href="#rekayasa" data-toggle="tab">Bahu Jalan</a></li>
				  <li><a href="#longsor" data-toggle="tab">Lereng</a></li>
				  <li><a href="#badan" data-toggle="tab">Bangunan Rekayasa</a></li>				 			  
                ...
                <div class="tab-content">
                  ...
                  <div class="tab-pane active" id="inpeksi" >                   
						<?php
						$this->load->view('modul/inspeksi/form_inpeksiberkala/inpeksi_jalan');
						?>				   
                  </div><!-- /#fa-icons -->
				 ...
				 <!-- Geometrik-->
                  <div class="tab-pane" id="intrumentasi">
						<?php
						$this->load->view('modul/inspeksi/form_inpeksiberkala/intrumentasi');
						?>
                  </div><!-- /#ion-icons -->
                  ...
                  <div class="tab-pane" id="geologi">
						<?php
						$this->load->view('modul/inspeksi/form_inpeksiberkala/drainase');
						?>
                  </div><!-- /#ion-icons -->
                  ...
                  <div class="tab-pane" id="lereng">
						<?php
						$this->load->view('modul/inspeksi/form_inpeksiberkala/badan');
						?>
                  </div><!-- /#ion-icons -->
                  ...
                  <div class="tab-pane" id="rekayasa">
						<?php
						$this->load->view('modul/inspeksi/form_inpeksiberkala/bahu');
						?>
                  </div><!-- /#ion-icons -->
                  ...
                  <div class="tab-pane" id="longsor">
						<?php
						$this->load->view('modul/inspeksi/form_inpeksiberkala/lereng');
						?>
                  </div><!-- /#ion-icons -->
                  ...
                  <div class="tab-pane" id="badan">
						<?php
					 $this->load->view('modul/inspeksi/form_inpeksiberkala/bangunanrekayasa');
						?>
                  </div><!-- /#ion-icons -->
                  ...
                  <div class="tab-pane" id="drainase">
						<?php
						//$this->load->view('modul/inspeksi/form_inventarisasi/drainase');
						?>
                  </div>
                  ...
                  <div class="tab-pane" id="intrumentasi">
						<?php
						//$this->load->view('modul/inspeksi/form_inventarisasi/intrumentasi');
						?>
                  </div>
                  ...
                  <div class="tab-pane" id="dokumentasi">
						<?php
						//$this->load->view('modul/inspeksi/form_inventarisasi/dokumentasi');
						?>
                  </div>
                  ...
                  <div class="tab-pane" id="sketsa">
						<?php
						//$this->load->view('modul/inspeksi/form_inventarisasi/sketsa');
						?>
                  </div>
