        ...
        <div class="box-body">
          ...
          <div class="row">
            <div class="col-xs-12 text-center">
             <form action="<?php echo base_url(); ?>index.php/inspeksi/berkala" method="post" class="form-horizontal">
				  ...
				  <select class="form-control">
                    ...
                    <option name='1'>Khusus</option>
                    <option name='2'>Rutin</option>
                    <option name='3'>Berkala</option>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input class="form-control" id="inputName" placeholder="Nomor Lereng " type="text">
                    </div>
                  </div>
