                ...
                <div class="tab-content">
				 ...
				 <!-- Geometrik-->
                  ...
                  <div class="tab-pane" id="geologi">
						<?php
						//$this->load->view('modul/inspeksi/form_inventarisasi/geologi');
						?>
                  </div><!-- /#ion-icons -->
                  ...
                  <div class="tab-pane" id="lereng">
						<?php
						//$this->load->view('modul/inspeksi/form_inventarisasi/lereng');
						?>
                  </div><!-- /#ion-icons -->
                  ...
                  <div class="tab-pane" id="rekayasa">
						<?php
						//$this->load->view('modul/inspeksi/form_inventarisasi/rekayasa');
						?>
                  </div><!-- /#ion-icons -->
                  ...
                  <div class="tab-pane" id="longsor">
						<?php
						//$this->load->view('modul/inspeksi/form_inventarisasi/longsor');
						?>
                  </div><!-- /#ion-icons -->
                  ...
                  <div class="tab-pane" id="badan">
						<?php
						//$this->load->view('modul/inspeksi/form_inventarisasi/badan');
						?>
                  </div><!-- /#ion-icons -->
